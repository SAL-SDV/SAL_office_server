...
conn = mysql.connector.connect(
    host = 'localhost',
    port = '3306',
    user = 'xxxx',  #Mariadbかmysqlにログインするid
    password = 'xxxxx',    #Mariadbかmysqlのパスワード
    database = 'xxxxx'  #Mariadbかmysqlで作成したデータベース名
)
...
url = "https://www.apple.com/jp/" #メールに使用するurl 


#本当は分岐させるが今はデータ追加時メール送信
if __name__ == '__main__':
    host = 'smtp.gmail.com'
    username, password = 'xxxxxx@gmail.com', 'xxxxxxx'#Gメールアカウントを使ってメール送信
    from_addr = "somebody@gmail.com"#送り主（何でも良い）
    to_addr = "xxxxxxx" #送り先(何でも良い)
    ...
    attach_file={'name':'xxxx.jpg','path':'xxxx.jpg'}#コンテンツのファイル名とファイルの場所をかく　データベースを決めればそこから直接画像取得できるかも
